...
public class ownerMyprofileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_owner_myprofile);
        ...
        DatabaseReference databaseReference = firebaseDatabase.getReference("VehicleOwner/Registration");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                                        ...
                                        if (!city.isEmpty()) {
                                            ...
                                            if (Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
                                                ...
                                                if (contact.length() == 10) {
                                                    ...
                                                    Toast.makeText(ownerMyprofileActivity.this, "Profile is Changed Successfully", Toast.LENGTH_SHORT).show();
                                                } else {
                    ...
                    Toast.makeText(ownerMyprofileActivity.this, "Data is not exists...Please check again", Toast.LENGTH_SHORT).show();
                }
            }
